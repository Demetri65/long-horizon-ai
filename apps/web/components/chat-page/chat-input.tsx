...
export function ChatInput({
  ...
  // Helper to reset the textarea height to fit contents
  ...
  // Update the input value and resize the textarea on each change
  const handleChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    setValue(e.target.value);
    resizeTextarea();
  };

  // Handle submission either via form submit or explicit button click
